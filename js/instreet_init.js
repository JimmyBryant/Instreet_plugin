...
(function(){
  ...
  var ranN=Math.round(Math.random()*1000000),funcName="callback_"+ranN,scriptUrl=actionUrl+"?pd="+widgetSid+"&callback="+funcName; 
  ...
  document.write('<script src="'+scriptUrl+'" charset="utf-8" type="text/javascript"><'+'/script>');
